...
const appleOAuthController = require('../controllers/AppleOAuthController');
...
router.post('/apple/login', (req, res) => socialAuthController.loginApple(req, res));
router.get('/apple/callback', (req, res) => appleOAuthController.callback(req, res));
router.post('/apple/callback', (req, res) => appleOAuthController.callback(req, res));
